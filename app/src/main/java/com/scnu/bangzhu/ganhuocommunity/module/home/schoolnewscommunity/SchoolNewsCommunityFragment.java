 ...
 */
public class SchoolNewsCommunityFragment extends Fragment implements SchoolNewsCommunityView, SwipeRefreshLayout.OnRefreshListener {
    //下拉刷新与加载相关变量
    ...
    private void initView() {
        ...
        mPresenter = new SchoolNewsCommunityPresenterImpl(this);
    }
